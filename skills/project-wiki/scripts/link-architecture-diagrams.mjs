...
const SOURCE_DIR = "project-wiki";
const SOURCE_NAME = "project-wiki";
...
function main() {
  ...
  const diagramBridge = path.join(diagramRoot, "PROJECT-WIKI-LINKS.md");
...
| Project Wiki Doc | Diagram HTML | Notes |
| --- | --- | --- |
| | | |

## Suggested placement

- ` + "`overview/`" + `: link high-level system map
- ` + "`architecture/`" + `: link service/component diagram
- ` + "`dataflow/`" + `: link runtime/sequence-like architecture view
`,
    force,
  );
...
| Diagram HTML | Project Wiki Doc | Notes |
| --- | --- | --- |
| | | |
`,
    force,
